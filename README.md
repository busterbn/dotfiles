...
| `dock`               | Remove all pinned apps, auto-hide with no delay and fast animation, icon size 68, hide recent apps, keep Spaces in fixed order, no dots under running apps, disable Quick Note hot corner, three-finger swipe down for App Exposé                                                                                                                                                                                                                                                                                                                                                       |
...
| `windowmanager`      | Tiled windows without margins, no tiling on edge drag or Option-drag, click on wallpaper doesn't reveal the desktop, hide desktop widgets, remove all widgets (desktop + Notification Center)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
