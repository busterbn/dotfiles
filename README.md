...
| Script         | What it does                                                                                                                                                                              |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bootstrap.sh` | Full setup: runs `install.sh`, then `make update deps font p10k git` (+ `iterm2 hammerspoon macos obsidian` on macOS, run as separate make calls). Safe to rerun. `make ssh` must be run manually |
